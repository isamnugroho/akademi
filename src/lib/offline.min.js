...
(function () {
    ...
    (d = function (a, b) {
        ...
        (c = {
            checks: {
                xhr: {
                    url: function () {
                        return "/favicon.ico?_=X" + Math.floor(1e9 * Math.random());
                    },
                },
                image: {
                    url: function () {
                        return "/favicon.ico?_=Z" + Math.floor(1e9 * Math.random());
                    },
                },
                active: "xhr",
            },
        ...
        (b = function (a, b, c) {
            ...
            return (
                ...
                null === a.onprogress
                    ? (a.addEventListener("error", c, !1), a.addEventListener("timeout", c, !1), a.addEventListener("load", d, !1))
                    ...
                    ? (Offline.on("confirmed-up", function () {
                      ...
                      Offline.onXHR(function (a) {
                          ...
                          return (
                              ...
                              b)
                                  ? null === e.onprogress
                                      ? (e.addEventListener("error", c, !1), e.addEventListener("timeout", c, !1))
    ...
    function () {
        ...
        for (e = ["up", "down"], c = 0, d = e.length; d > c; c++)
            (a = e[c]),
                (document.querySelector("script[data-simulate='" + a + "']") || localStorage.OFFLINE_SIMULATE === a) &&
                    (null == Offline.options && (Offline.options = {}), null == (b = Offline.options).checks && (b.checks = {}), (Offline.options.checks.active = a));
    }.call(this),
    function () {
        ...
        (b = '<div class="offline-ui"><div class="offline-ui-content"></div></div>'),
            ...
            (k = function () {
                ...
                return (
                    (f = e(b)),
                    document.getElementById("demo_offline").appendChild(f),
